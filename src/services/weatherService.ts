 ...
 */
function getMostSignificantWeather(conditions: WeatherCondition[]): WeatherCondition {
  ...
  return conditions.reduce((mostSignificant, current) => {
    return priority[current] > priority[mostSignificant] ? current : mostSignificant;
